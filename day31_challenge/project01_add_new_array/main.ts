...
let fruitsBuy: string[] = ["Strawberry", "Lichi", "Apple"];
fruitsBuy.push("Banana"); // Adds "Mango" to the end of the array

console.log(fruitsBuy); // Outputs: ['Apple', 'Banana', 'Cherry', 'Mango']
